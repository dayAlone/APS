...
<div class="sections">
    ...
    foreach ($arResult['SECTIONS'] as $key => &$item):
        if($arParams['SMALL'] == 'Y') {
            ...
            if($i % 2 == 0) { ?> <div class="col-md-12 visible-md col-sm-12 visible-sm"></div><? }
        } else {
        ...
        ?>
        <div class=" <?=($arParams['SMALL']=='Y'?"col-md-6 col-lg-4 col-sm-6":"col-md-4 col-lg-3 col-sm-6")?> col-xs-12">
